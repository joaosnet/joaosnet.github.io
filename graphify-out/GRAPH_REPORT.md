# Graph Report - joaosnet.github.io  (2026-06-08)

## Corpus Check
- 21 files · ~1,338,248 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 454 nodes · 602 edges · 32 communities (16 shown, 16 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3fcbb50d`
...
5. `main()` - 14 edges
6. `AnimationsHandler` - 13 edges
7. `GeoViewsCounter` - 13 edges
...
- **Why does `get_api_token()` connect `Community 27` to `Community 24`, `Community 25`, `Community 2`, `Community 12`?**
